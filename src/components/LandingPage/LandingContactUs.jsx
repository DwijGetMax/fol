...
const LandingContactUs = () => {
  ...
  return (
    <>
      <div class="max-w-4xl mx-auto bg-white pt-0 pb-6 font-[sans-serif] text-[#011c2b]">
        <div class="text-center px-6">
          <h2 class="text-4xl text-[#1b1c44] font-semibold pt-6">
        ...
        <div class="grid lg:grid-cols-3 items-center gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-8">
          <div class="bg-[#011c2b] rounded-lg p-6 max-lg:text-center">
            ...
            <p class="text-sm text-gray-400 mt-3">
              Reach out to us today for personalized support tailored to your
              needs. We're here to listen, assist, and start a conversation with
              you.
            </p>
            ...
            <ul class="flex max-lg:justify-center mt-16 space-x-4">
              {/* <li class="bg-gray-800 hover:bg-gray-900 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                <Link
                  to="https://www.facebook.com/TechAtGetMax"
                  target="_blank"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li class="bg-gray-800 hover:bg-gray-900 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                <Link
                  to="https://www.linkedin.com/company/getmax/"
                  target="_blank"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <form onSubmit={handleSubmit}>
              <div class="grid sm:grid-cols-2 gap-8">
                ...
                <div class="col-span-full">
                  <div class="flex max-lg:flex-col lg:space-x-6 max-lg:space-y-6 focus:border-[#011c2b] ">
                    <div className="relative flex items-center mt-3">
                      <label
                        className="block mb-2 text-sm text-gray-600 dark:text-gray-400 focus:border-[#011c2b] "
                        htmlFor="inquiryType"
                      >
                        Inquiry Type
                      </label>
                ...
                <div class="col-span-full">
                  <div class="relative mt-3">
                    ...
                    <textarea
                      ...
                      name="message"
                      placeholder="Write Message"
                      class="w-full px-2 pt-3 bg-white text-black text-sm border-b-2 focus:border-[#011c2b] outline-none"
                    ></textarea>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="#bbb"
