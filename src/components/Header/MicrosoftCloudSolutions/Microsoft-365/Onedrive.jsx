...
const Onedrive = () => {
  ...
  return (
    <>
      <div class="flex h-screen justify-center items-center dark:bg-slate-800 pt-0">
        <div class="mx-auto mt-0 flex justify-center px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-8 lg:px-8">
          <div class="text-center ">
            <h1 class="text-3xl font-semibold tracking-tight text-gray-900 dark:text-slate-200 sm:text-5xl md:text-6xl">
              <span class="block xl:inline">
                <span class="mb-1 block text-slate-900">Microsoft 365</span>
            ...
            <video
              class="border-2 border-gray-300 rounded-lg shadow-lg justify-center items-center"
